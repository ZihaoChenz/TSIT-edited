...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--s_image', type=str, help='reference image, if you want to set a single style image')
        parser.add_argument('--c_path', type=str, help='the content data folder, you can use your own dataset')
